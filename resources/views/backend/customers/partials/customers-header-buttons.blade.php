<!--Action Button-->
@if( Active::checkUriPattern( 'admin/customers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.customers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.customers.all' ) }}
            </a>
        </li>
        @permission( 'create-customer' )
            <li>
                <a href="{{ route( 'admin.customers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.customers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
